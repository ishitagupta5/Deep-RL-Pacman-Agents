...
class Game:
    ...
    def __init__(self, agents, horizon, display, rules, starting_index=0, mute_agents=False, catch_exceptions=False):
    ...
    def run(self):
        ...
        while not self.game_over and (self.horizon < 0 or timestep < self.horizon):
            timestep += 1
